...
> Last updated: 2026-07-26 13:01 ET | Programs: 3 active

## Executive Summary

| Metric | Value |
|--------|-------|
| Total issues auto-created | 131 (link-health: 92, dep-bump: 39) |
| Total issues auto-resolved | 29 |
| Total PRs auto-opened | 0 |
| Estimated hours saved | 7.2 hrs (at 15 min/resolved issue) |
| PRs reviewed by clawgenti | 83 |
| Programs active | 3 |
| Last successful scan | 2026-07-24 |
...
| Broken (internal) | 53 | -31 from first scan |
| Broken (external) | 653 | +623 from first scan |
| Issues created (cumulative) | 92 | |
...
| PRs reviewed (cumulative) | 83 | failed: 0 |
...
| openshell-driver-openshift | yes | no | no | 1 |
...
### Coverage Summary
- Repos under at least one program: 19 / 19 (100%)
- Repos under all programs: 0 / 19 (0%)

## Cron Health

| Job | Schedule | Last Run | Status |
|-----|----------|----------|--------|
| link-health-scanner | Mon/Wed/Fri 7am ET | 2026-07-24 | ok |
| link-health-fixer | Tue/Thu 8am ET | 2026-07-24 | ok |
| dep-bump-scanner | Tue/Thu 10am ET | 2026-07-24 | ok |
| dep-bump-fixer | Tue/Thu 12pm ET | 2026-07-24 | ok |
| pr-review-scanner | every ~15 min | 2026-07-24 | ok |
| pr-review-fixer | every ~15 min | 2026-07-24 | ok |
